(function(){
    ...
    NotificationController.$inject = [
        ...
        'User',
        '$window'];
    function NotificationController($rootScope, $scope, $state, AlertService, $translate, apiData, $http, $filter, ErrorHandle, LogsService,  User, $window) {
...
//                }
                ...
                if(notify_data.objectType == 'Alarm'){
                    var param = {'alarmId': notify_data.objectId};
