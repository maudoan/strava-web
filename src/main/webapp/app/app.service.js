erpApp
    ...
    .factory('apiData', ['$http','$q','HOST_GW',
        function($http, $q, HOST_GW) {
            var service = {
            ...
            function getFkValue(field,value) {
                if(angular.isUndefined(value) || value == null) return '';
                return $http.get(HOST_GW + '/api/personal-configs/get-fk-value?fieldName=' + field + '&fk=' +value).then(function (response) {
            ...
            function genApi(api, searchField, searchValue, size, typefilter, originparams, page, queryReplace,order) {
