(function () {
    ...
    angular.module('erpApp')
        .controller('LogTypeCreateController', LogTypeCreateController);

    LogTypeCreateController.$inject = ['$rootScope', '$scope', '$state', '$http','$timeout','$window',
        'AlertService', '$translate', 'TableController', 'ComboBoxController','Common', 'AlertModalService', 'LogType','ErrorHandle'];

    function LogTypeCreateController($rootScope, $scope, $state, $http,$timeout,$window,
                                         AlertService, $translate, TableController, ComboBoxController, Common, AlertModalService, LogType,ErrorHandle) {
        ...
        function createLogType(isClose){
            LogType.create($scope.logType).then(function(data){
                if($scope.blockModal != null) $scope.blockModal.hide();
